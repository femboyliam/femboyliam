...
[![Fabric](https://img.shields.io/badge/Fabric-%23FFFFFF.svg?style=for-the-badge&logo=data:image/png;base64,)](https://fabricmc.net/)
...
[![C#](https://img.shields.io/badge/c%23-%23239120.svg?style=for-the-badge&logo=c-sharp&logoColor=white)](https://dotnet.microsoft.com/en-us/download)
...
[![Visual Studio](https://img.shields.io/badge/Visual%20Studio-5C2D91.svg?style=for-the-badge&logo=visual-studio&logoColor=white)](https://visualstudio.microsoft.com/downloads/)
...
[![PostgreSQL](https://img.shields.io/badge/postgres-%23316192.svg?style=for-the-badge&logo=postgresql&logoColor=white)](https://www.postgresql.org/download/)
...
## 🎮 Game Development
[![Unity](https://img.shields.io/badge/unity-%23000000.svg?style=for-the-badge&logo=unity&logoColor=white)](https://unity.com/download)
[![Unreal Engine](https://img.shields.io/badge/unrealengine-%23313131.svg?style=for-the-badge&logo=unrealengine&logoColor=white)](https://www.unrealengine.com/en-US/download)
[![Godot Engine](https://img.shields.io/badge/GODOT-%23FFFFFF.svg?style=for-the-badge&logo=godot-engine)](https://godotengine.org/download/)
[![LWJGL](https://img.shields.io/badge/LWJGL-3B9C67.svg?style=for-the-badge&logo=java&logoColor=white)](https://www.lwjgl.org/)

## 📊 GitHub Stats:
![](https://github-readme-stats.vercel.app/api?username=liam&theme=dracula&hide_border=false&include_all_commits=true&count_private=true)<br/>
![](https://github-readme-streak-stats.herokuapp.com/?user=liam&theme=dracula&hide_border=false)<br/>
![](https://github-readme-stats.vercel.app/api/top-langs/?username=liam&theme=dracula&hide_border=false&include_all_commits=true&count_private=true&layout=compact)

## 💬 Code Snippets

```java
// Minecraft plugin event handler example
@EventHandler
public void onPlayerJoin(PlayerJoinEvent event) {
    Player player = event.getPlayer();
    player.sendMessage(ChatColor.LIGHT_PURPLE + "✨ Welcome to the server, " + player.getName() + "! ✨");
...
```java
// Custom item creation in Minecraft
public ItemStack createMagicWand() {
    ...
    lore.add(ChatColor.ITALIC + "A wand infused with magical energy");
    lore.add(ChatColor.BLUE + "Right-click to cast a spell");
    meta.setLore(lore);
...
## 📫 Contact Me
[![Discord](https://img.shields.io/badge/Discord-%237289DA.svg?style=for-the-badge&logo=discord&logoColor=white)](https://discord.gg/liam)
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:liam@example.com)

<div align="center">
  <img src="https://komarev.com/ghpvc/?username=liam&style=flat-square&color=ff69b4" alt="Profile views counter"/>
</div>
